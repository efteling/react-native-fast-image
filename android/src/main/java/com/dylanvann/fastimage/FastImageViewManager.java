...
class FastImageViewManager extends SimpleViewManager<FastImageViewWithUrl> implements FastImageProgressListener {
  ...
  public void setTransition(FastImageViewWithUrl view, ReadableMap source) {
    final FastImageTransition transition = FastImageViewConverter.getTransition(source);

...
class FastImageViewWithUrl extends AppCompatImageView {
  ...
  private FastImageTransition mTransition = null;
  ...
  public void setTransition(@Nullable FastImageTransition transition) {
    mNeedsReload = true;
  ...
  public void onAfterUpdate(
    ...
    if (requestManager != null) {
      ...
      if (mTransition != null) {
        builder.transition(mTransition.transitionOptions());
      }
